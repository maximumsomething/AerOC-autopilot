...
def updateVals():
	...
	while True:
		...
		updateValsForLine("controlOut", ["targetPitch", "targetVertSpeed", "targetAltitude", "targetRoll", "targetBearing", "elevators", "ailerons", "throttle", "rudder"], [tarPitch, tarVertSpeed, tarAltitude, tarRoll, tarBearing, elevatorSignal, aileronSignal, throttleSignal, rudderSignal])
